...
int main () {
  ...
  */
  // Chave de 192 bits
  unsigned char *key = (unsigned char *)"10987654321098987654321098765432";
  // Vetor de inicializacao de 128 bits
  unsigned char *iv = (unsigned char *)"4567890123450123";
  // Mensagem a ser criptografada
  unsigned char *plaintext = (unsigned char *)"AES 192 CTR";
